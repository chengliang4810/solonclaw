...
//
// Both gate on SOLONCLAW_DEV_PERF=1 and dump JSON-lines (default ~/.solonclaw/perf.log,
// override SOLONCLAW_DEV_PERF_LOG). Tagged { src: 'react' | 'frame' } for jq.
// SOLONCLAW_DEV_PERF_MS (default 2) skips sub-ms idle frames; set 0 to capture all.
//
...
const THRESHOLD_MS = Number(process.env.SOLONCLAW_DEV_PERF_MS ?? '2') || 0
const LOG_PATH = process.env.SOLONCLAW_DEV_PERF_LOG?.trim() || join(homedir(), '.solonclaw', 'perf.log')
