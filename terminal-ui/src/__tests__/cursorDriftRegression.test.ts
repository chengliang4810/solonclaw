 ...
 *
 * Symptom: in `solonclaw`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@solon-claw/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using solonclaw and as i type multiline my caret at the end will often ' +
