...
## Hermes 参考
- `/Users/chengliang/code-repositories/hermes-agent/tools/cronjob_tools.py`

## 当前项目目标文件
- `src/main/java/com/jimuqu/solon/claw/scheduler/CronJobService.java`

## 当前缺口
当前 create/update validation 会扫描用户 prompt，但对 invisible Unicode 与 exfiltration-style payload 的创建期硬化还未完整对齐 Hermes cron tool chain。
