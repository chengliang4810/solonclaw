...
final class DangerousCommandApprovalTestSupport {
    ...
    /** 清理当前线程中的策略审批状态，防止测试之间互相污染。 */
    static void clearThreadPolicyApprovals() {
     ...
     */
    static TestEnvironment approvalEnvironment() throws Exception {
     ...
     * @return 返回已创建的工作区目录。
     */
    static File workspaceBoundaryWorkspace(String label) throws Exception {
