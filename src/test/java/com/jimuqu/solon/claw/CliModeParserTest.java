...
public class CliModeParserTest {
    ...
    void shouldGenerateShellCompletionScripts() throws Exception {
        ...
        assertThat(bash)
                ...
                .contains(
                        "--session --ask -p /help /models /sessions /session /history /title /events /tasks /attachments /transcript /tips /queue /steer /skin /copy /exit /quit /exit! /quit!");
        assertThat(zsh)
                ...
                .contains("/help /models /sessions /session /history /title /events /tasks /attachments /transcript /tips /queue /steer /skin /copy /exit /quit /exit! /quit!")
