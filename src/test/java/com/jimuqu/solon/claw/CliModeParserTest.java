...
public class CliModeParserTest {
    ...
    void shouldGenerateShellCompletionScripts() throws Exception {
        ...
        assertThat(bash)
                ...
                .contains(
                        "--session --ask -p /help /models /sessions /session /history /title /events /tasks /attachments /tips /queue /steer /skin /copy /exit /quit");
        assertThat(zsh)
                ...
                .contains("/help /models /sessions /session /history /title /events /tasks /attachments /tips /queue /steer /skin /copy /exit /quit")
