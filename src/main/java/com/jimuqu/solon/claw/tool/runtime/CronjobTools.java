...
public class CronjobTools {
    ...
    public String cronjob(
            ...
            @Param(name = "deliver", description = "local、origin、平台名、platform:chat_id[:thread_id]，可用逗号投递多目标", required = false) String deliver,
            @Param(name = "skill", description = "单个技能名", required = false) String skill,
