...
public final class LocalTerminalHelp {
    ...
    public static String text() {
        return "本地终端命令：\n"
                ...
                + "/security audit|policy|approvals|slash-confirm|lifecycle|hardline|terminal-guardrails|tirith|tirith-approval|cron-approvals|subagent-approvals|smart-approval|urls|private-urls|website|paths|credentials|tool-args|mcp|schema|attachments|terminal-paste|media-cache|tool-results|patch|code-execution|subprocess-env|terminal-output|sudo|process - 查看安全审计、审批、URL、路径、凭据、MCP、执行和工具策略摘要\n"
