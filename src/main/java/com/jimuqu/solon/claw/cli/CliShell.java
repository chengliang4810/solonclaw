...
public class CliShell {
    ...
    private int sendOnce(
        ...
        AttachmentPathResolver.ResolvedInput resolved = resolveAttachments(input);
     ...
     * @return 返回解析后的附件。
     */
    private AttachmentPathResolver.ResolvedInput resolveAttachments(String input) {
        if (attachmentResolver == null) {
            return new AttachmentPathResolver.ResolvedInput(
