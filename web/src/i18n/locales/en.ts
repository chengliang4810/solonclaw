export default {
  ...
  terminal: {
    ...
    copySelection: 'Copy',
    copySelectionTip: 'Copy the current terminal selection',
    paste: 'Paste',
    pasteTip: 'Paste from the system clipboard into the terminal',
    clear: 'Clear',
    clearTip: 'Clear the current terminal display',
    shortcutsButton: 'Shortcuts',
    shortcutsTitle: 'Terminal Shortcuts',
    shortcutNewTab: 'Create a terminal',
    shortcutClose: 'Close current terminal',
    shortcutClear: 'Clear display',
    shortcutCopy: 'Copy selection',
    shortcutPaste: 'Paste clipboard',
    shortcutSwitch: 'Switch terminal 1-9',
