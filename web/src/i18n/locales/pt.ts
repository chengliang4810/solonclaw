export default {
  ...
  login: {
    ...
    description: 'Insira seu token de acesso para continuar. Configure solonclaw.dashboard.accessToken no servidor ou por parametro de inicializacao.',
  ...
  sidebar: {
    ...
    logout: 'Sair',
    nodeVersionWarning: 'Node.js v{version} detectado. Atualize para a versao 23 ou superior.',
  ...
  chat: {
    ...
    emptyState: 'Inicie uma conversa com o solonclaw Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Do login QR da CLI weixin (Jimuqu weixin)',
  ...
  channels: {
    description: 'Configure os canais domesticos compativeis e revise o status do gateway apos a configuracao.',
    mediaCache: 'Cache de midia',
    mediaDescription: 'Revise registros de midia indexados dos canais domesticos compativeis.',
    mediaRefresh: 'Atualizar',
    mediaIndexLocal: 'Indexar arquivo local',
    mediaIndexPlaceholder: 'Caminho local do arquivo no servidor',
    mediaIndexReady: 'Arquivo de midia local indexado',
    mediaIndexFailed: 'Falha ao indexar arquivo de midia local',
    mediaRefreshDetail: 'Atualizar detalhes',
    mediaDownload: 'Preparar download',
    mediaMakeReference: 'Gerar referencia',
    mediaDownloadReady: 'Referencia de download de midia pronta',
    mediaDownloadFailed: 'Falha ao preparar download de midia',
    mediaReferenceReady: 'Referencia de midia pronta',
    mediaReferenceFailed: 'Falha ao gerar referencia de midia',
    mediaDetail: 'Detalhe da midia',
    mediaLoadFailed: 'Falha ao carregar o cache de midia',
    mediaEmpty: 'Nenhum registro de cache de midia',
    mediaStatus: 'Status',
    mediaPlatform: 'Plataforma',
    mediaKind: 'Tipo',
    mediaSize: 'Tamanho',
    mediaUpdated: 'Atualizado',
    mediaPath: 'Caminho local',
    mediaReference: 'Referencia',
    mediaError: 'Erro',
  },
  ...
  files: {
    ...
    confirmRestore: 'Restaurar "{name}" para o conteudo padrao? O conteudo atual sera sobrescrito.',
  ...
  download: {
    ...
    unsupportedBackend: 'O backend local atual nao suporta download de arquivos',
