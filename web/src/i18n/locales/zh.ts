export default {
  ...
  jobs: {
    ...
    deliverTarget: '投递目标',
    deliverPlaceholder: 'origin、local、feishu:chat_id[:thread_id]，可逗号分隔多个目标',
    deliverChatId: '投递会话 ID',
    deliverChatIdPlaceholder: '可选，指定目标 chat_id / open_conversation_id',
    deliverChatIdRequired: '指定会话投递需要填写投递会话 ID',
    deliverThreadId: '投递线程 ID',
    deliverThreadIdPlaceholder: '可选，指定线程或消息 ID',
    deliverPreview: '投递预览',
    origin: '来源',
    local: '本地',
    repeatCount: '重复次数（可选）',
    ...
    wrapResponse: '包装投递结果',
    script: '脚本',
    scriptPlaceholder: 'runtime/scripts 下的相对路径，例如 watchdog.sh',
    scriptRequiredForNoAgent: '跳过 Agent 模式必须填写脚本',
    promptOrSkillRequired: '非脚本直投模式需要填写提示词或至少一个技能',
    noAgent: '跳过 Agent',
    workdir: '工作目录',
    workdirPlaceholder: '绝对路径；用于注入项目上下文并作为工具工作目录',
    contextFrom: '上游任务',
    contextFromPlaceholder: '上游 job_id，多个用逗号分隔',
    enabledToolsets: '启用工具集',
    enabledToolsetsPlaceholder: 'web, terminal, file, delegation',
    provider: '模型提供方',
    providerPlaceholder: '可选，例如 default',
    model: '模型',
    modelPlaceholder: '可选，例如 gpt-5.4',
    baseUrl: 'Base URL',
    baseUrlPlaceholder: '可选，模型 API base URL',
    jobCreated: '任务已创建',
    jobUpdated: '任务已更新',
    nameRequired: '名称为必填项',
  ...
  terminal: {
    ...
    copySelection: '复制',
    copySelectionTip: '复制当前终端选区',
    paste: '粘贴',
    pasteTip: '从系统剪贴板粘贴到终端',
    clear: '清屏',
    clearTip: '清空当前终端显示',
    shortcutsButton: '快捷键',
    shortcutsTitle: '终端快捷键',
    shortcutNewTab: '新建终端',
    shortcutClose: '关闭当前终端',
    shortcutClear: '清屏',
    shortcutCopy: '复制选区',
    shortcutPaste: '粘贴剪贴板',
    shortcutSwitch: '切换第 1-9 个终端',
