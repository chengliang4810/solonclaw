export default {
  ...
  channels: {
    description: '対応する国内メッセージチャネルを設定し、設定後にゲートウェイ状態を確認します。',
    mediaCache: 'メディアキャッシュ',
    mediaDescription: '対応する国内チャネルから索引済みのメディア記録を確認します。',
    mediaRefresh: '更新',
    mediaIndexLocal: 'ローカルファイルを索引',
    mediaIndexPlaceholder: 'サーバー上のローカルファイルパス',
    mediaIndexReady: 'ローカルメディアファイルを索引しました',
    mediaIndexFailed: 'ローカルメディアファイルの索引に失敗しました',
    mediaRefreshDetail: '詳細を更新',
    mediaDownload: 'ダウンロードを準備',
    mediaMakeReference: '参照を生成',
    mediaDownloadReady: 'メディアダウンロード参照を準備しました',
    mediaDownloadFailed: 'メディアダウンロード参照の準備に失敗しました',
  ...
  files: {
    ...
    confirmRestore: '「{name}」を既定内容に戻しますか？現在の内容は上書きされます。',
