export default {
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec solonclaw Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Depuis la connexion QR de la CLI weixin (Jimuqu weixin)',
  ...
  channels: {
    description: 'Configurez les canaux domestiques pris en charge et verifiez l\'etat de la passerelle apres configuration.',
    mediaCache: 'Cache media',
    mediaDescription: 'Consultez les enregistrements media indexes depuis les canaux domestiques pris en charge.',
    mediaRefresh: 'Actualiser',
    mediaIndexLocal: 'Indexer un fichier local',
    mediaIndexPlaceholder: 'Chemin local du fichier sur le serveur',
    mediaIndexReady: 'Fichier media local indexe',
    mediaIndexFailed: 'Echec de l\'indexation du fichier media local',
    mediaRefreshDetail: 'Actualiser le detail',
    mediaDownload: 'Preparer le telechargement',
    mediaMakeReference: 'Generer une reference',
    mediaDownloadReady: 'Reference de telechargement media prete',
    mediaDownloadFailed: 'Echec de la preparation du telechargement media',
    ...
    mediaKind: 'Type',
    mediaSize: 'Taille',
    mediaUpdated: 'Mis a jour',
    mediaPath: 'Chemin local',
  ...
  files: {
    ...
    confirmRestore: 'Restaurer "{name}" avec le contenu par defaut ? Le contenu actuel sera remplace.',
