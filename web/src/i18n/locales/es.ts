export default {
  ...
  sidebar: {
    ...
    nodeVersionWarning: 'Node.js v{version} detectado. Actualice a la version 23 o superior.',
  ...
  chat: {
    ...
    deleteFailed: 'No se pudo eliminar la sesion',
    rename: 'Renombrar',
    pin: 'Fijar',
    unpin: 'Desfijar',
    pinned: 'Fijados',
  ...
  channels: {
    description: 'Configure los canales domesticos compatibles y revise el estado del gateway despues de configurarlos.',
    mediaCache: 'Cache de medios',
    mediaDescription: 'Revise registros de medios indexados desde canales domesticos compatibles.',
    mediaRefresh: 'Actualizar',
    mediaIndexLocal: 'Indexar archivo local',
    mediaIndexPlaceholder: 'Ruta local del archivo en el servidor',
    mediaIndexReady: 'Archivo de medio local indexado',
    mediaIndexFailed: 'Error al indexar archivo de medio local',
    mediaRefreshDetail: 'Actualizar detalle',
    mediaDownload: 'Preparar descarga',
    mediaMakeReference: 'Generar referencia',
    mediaDownloadReady: 'Referencia de descarga de medio lista',
    mediaDownloadFailed: 'Error al preparar descarga de medio',
    ...
    mediaKind: 'Tipo',
    mediaSize: 'Tamano',
    mediaUpdated: 'Actualizado',
    mediaPath: 'Ruta local',
  ...
  files: {
    ...
    confirmRestore: '?Restaurar "{name}" al contenido predeterminado? El contenido actual se sobrescribira.',
