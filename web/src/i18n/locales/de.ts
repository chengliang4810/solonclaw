export default {
  ...
  login: {
    ...
    description: 'Geben Sie Ihren Zugangs-Token ein, um fortzufahren. Setzen Sie solonclaw.dashboard.accessToken in der Server-Konfiguration oder per Startparameter.',
  ...
  sidebar: {
    ...
    logout: 'Abmelden',
    nodeVersionWarning: 'Node.js v{version} erkannt. Bitte auf Version 23 oder neuer aktualisieren.',
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit solonclaw Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Von Weixin-CLI QR-Anmeldung (Jimuqu weixin)',
    accountId: 'Konto-ID',
  ...
  channels: {
    description: 'Unterstutzte Inland-Nachrichtenkanale konfigurieren und danach den Gateway-Status prufen.',
    mediaCache: 'Mediencache',
    mediaDescription: 'Indizierte Mediendatensatze aus unterstutzten Inlandskanalen prufen.',
    mediaRefresh: 'Aktualisieren',
    mediaIndexLocal: 'Lokale Datei indizieren',
    mediaIndexPlaceholder: 'Lokaler Dateipfad auf dem Server',
    mediaIndexReady: 'Lokale Mediendatei indiziert',
    mediaIndexFailed: 'Lokale Mediendatei konnte nicht indiziert werden',
    mediaRefreshDetail: 'Details aktualisieren',
    mediaDownload: 'Download vorbereiten',
    mediaMakeReference: 'Referenz erzeugen',
    mediaDownloadReady: 'Medien-Downloadreferenz ist bereit',
    mediaDownloadFailed: 'Medien-Download konnte nicht vorbereitet werden',
    ...
    mediaKind: 'Art',
    mediaSize: 'Grosse',
    mediaUpdated: 'Aktualisiert',
    mediaPath: 'Lokaler Pfad',
    mediaReference: 'Referenz',
    mediaError: 'Fehler',
  },
  ...
  files: {
    ...
    confirmRestore: '"{name}" mit Standardinhalt wiederherstellen? Der aktuelle Inhalt wird uberschrieben.',
