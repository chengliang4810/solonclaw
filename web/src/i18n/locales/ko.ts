export default {
  ...
  channels: {
    description: '지원되는 국내 메시지 채널을 설정하고 설정 후 게이트웨이 상태를 확인합니다.',
    mediaCache: '미디어 캐시',
    mediaDescription: '지원되는 국내 채널에서 인덱싱된 미디어 기록을 확인합니다.',
    mediaRefresh: '새로고침',
    mediaIndexLocal: '로컬 파일 인덱싱',
    mediaIndexPlaceholder: '서버의 로컬 파일 경로',
    mediaIndexReady: '로컬 미디어 파일이 인덱싱되었습니다',
    mediaIndexFailed: '로컬 미디어 파일 인덱싱 실패',
    mediaRefreshDetail: '상세 새로고침',
    mediaDownload: '다운로드 준비',
    mediaMakeReference: '참조 생성',
    mediaDownloadReady: '미디어 다운로드 참조가 준비되었습니다',
    mediaDownloadFailed: '미디어 다운로드 준비 실패',
  ...
  files: {
    ...
    confirmRestore: '"{name}"을(를) 기본 내용으로 복원하시겠습니까? 현재 내용은 덮어씁니다.',
    deleteFailed: '삭제 실패',
    deleted: '삭제됨',
    renameTo: '새 이름',
    newFileName: '파일 이름',
