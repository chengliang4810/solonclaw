...
import SkillList from '@/components/jimuqu/skills/SkillList.vue'
import SkillDetail from '@/components/jimuqu/skills/SkillDetail.vue'
import { fetchSkills, type SkillCategory } from '@/api/jimuqu/skills'
