...
import { renameSession } from '@/api/jimuqu/sessions'
import { useChatStore, type Session } from '@/stores/jimuqu/chat'
import { useSessionBrowserPrefsStore } from '@/stores/jimuqu/session-browser-prefs'
...
const collapsedGroups = ref<Set<string>>(new Set(JSON.parse(localStorage.getItem('jimuqu_collapsed_groups') || '[]')))
...
function toggleGroup(source: string) {
  ...
  localStorage.setItem('jimuqu_collapsed_groups', JSON.stringify([...collapsedGroups.value]))
}

watch(groupedSessions, groups => {
  if (localStorage.getItem('jimuqu_collapsed_groups') !== null) {
