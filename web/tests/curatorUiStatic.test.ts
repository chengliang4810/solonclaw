...
assert.ok(systemNav.includes('SYSTEM_NAV_ITEMS'), 'system navigation component should render shared system entries')
assert.ok(sidebarNav.includes("key: 'solonclaw.curator'"), 'system navigation catalog should link to curator page')
